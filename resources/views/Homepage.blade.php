       ...
       <x-Navbar />
            ...
            <div class="container-fluid">
                ...
                <div class="row ">
                    ...
                    <x-Card style="margin: -50px;" :productID="$e['productID']" :picPath="$e['picPath']" :picPath2="$e['picPath2']"  :productTitle="$e['Title']" :productCategory="$e['SubCategory']" :productPrice="$e['price']" :discounted="$e['discountedPrice']" />
                    @if ($loop->index == 3)
                    @break
                    @endif
                    @endforeach
